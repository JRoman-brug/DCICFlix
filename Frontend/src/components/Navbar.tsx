...
export const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      {/* Live search bar - shows suggestions as user types (case-insensitive) */}
                ...
                debounceRef.current = window.setTimeout(() => {
                  void (async () => {
                    ...
                    try {
                      ...
                      // Ensure case-insensitive match on client in case backend is different
      ...
      <NavbarContent justify="end">
        {/* Note: the input above will be replaced by the controlled input below via navigate handler. */}
        <NavbarItem>
          <Link
            to="/recomendations"
